        ...
        ,openTabsPage = function(url, text){
            ...
            var setThisTab = function(){
                ...
                if( iframes && iframes.length > 0 ){
                    var iframe = iframes[tabsPage.index];
                    var src = document.location.protocol + "//" + window.location.host + url;
                    if( iframe != null && src !== iframe.contentWindow.location.href.toString() ){
                        //alert(tabsPage.index);
                        console.log("iframe=" + tabsPage.index + " 重置URL" + src)
                        iframe.src = src;
                    }
                }
